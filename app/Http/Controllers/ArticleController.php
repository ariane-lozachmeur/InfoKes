...
class ArticleController extends Controller
{
    ...
    {
        $data=PagesController::dataCommune('article.show',true);
        $data['articles'] = ArticleController::getFiles();
        return view('articles.files',$data);
    }

    public function deleteFile($id){
        $article = Article::findOrFail($id);
        unlink($article->fichier);
    ...
    public static function getLatestArticles($nombre){
        $articles = Article::where('relu',true)->latest('published_at')->paginate($nombre);
        return $articles;
    }
